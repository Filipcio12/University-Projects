...
public class AuthRESTController {
    ...
    @Autowired
    public AuthRESTController(DaoAuthenticationProvider daoAuthenticationProvider, UserRepository userRepository, RoleRepository roleRepository, PasswordEncoder passwordEncoder, JwtProvider jwtProvider, PatientRepository patientRepository) {
    ...
    public ResponseEntity<?> registerPatient(@Valid @RequestBody Patient patient) {
        System.out.println(patient.getUser().getRoles());
